# Flask Sample Application (Python 3.11.14)

This is a simple Flask web application built using **Flask 2.3.x** and **Python 3.11.14**.  
...
To run this application with **Python 3.11.14**, set your `runtime.txt` file to:
