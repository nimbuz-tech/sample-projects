# Flask Sample Application (Python 3.7.17)

This is a simple Flask web application built using **Flask 2.3.x** and **Python 3.7.17**.  
...
To run this application with **Python 3.7.17**, set your `runtime.txt` file to:
