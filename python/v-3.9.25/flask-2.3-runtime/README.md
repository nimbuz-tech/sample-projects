# Flask Sample Application (Python 3.9.25)

This is a simple Flask web application built using **Flask 2.3.x** and **Python 3.9.25**.  
...
To run this application with **Python 3.9.25**, set your `runtime.txt` file to:
