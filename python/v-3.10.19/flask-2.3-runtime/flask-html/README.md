# Flask Sample Application (Python 3.10.19)

This is a simple Flask web application built using **Flask 2.3.x** and **Python 3.10.19**.  
...
To run this application with **Python 3.10.19**, set your `runtime.txt` file to:
